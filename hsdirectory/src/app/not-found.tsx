    ...
    return (
        <div className="container mx-auto px-4 py-16">
            <div className="max-w-md mx-auto text-center">
                ...
                <h2 className="text-xl font-semibold text-[var(--foreground)] opacity-80 mb-4">
                    Page Not Found
                </h2>
              ...
              bg-[var(--primary)] text-white font-medium hover:bg-[var(--primary-hover)] transition-colors"
                    >
                        Go Home
                    </Link>
                    <Link
